        ...
        <div class="card-body">
          ...
          if($detail->status_pembayaran=='belum_dibayar'){
            if($detail->jenis_pembayaran=='cash'){
              ...
              <div class="alert alert-danger" role="alert">
                <h4 class="alert-heading">Silahkan lakukan pembayaran</h4>
                <p class="mb-0">Untuk menyelesaikan pembayaran ini, transfer sejumlah <b><?=rupiah($detail->total_bayar)?></b> ke Rekening 1003000100 (BCA) / 1201390124444 (MANDIRI) An Dennis Andressa.<br>
